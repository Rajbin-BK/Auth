...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sha256Hash = hash('sha256', $password . $salt);
    ...
    try {
        ...
        $stmt = $pdo->prepare("
            INSERT INTO users (email, firstname, lastname, city, country, password_sha256, salt)
            VALUES (:email, :first, :last, :city, :country, :password_sha256, :salt)
        ");
        ...
        $stmt->bindValue(':password_sha256', $sha256Hash);
