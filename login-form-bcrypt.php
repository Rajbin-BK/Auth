...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if ($userData) {
            ...
            if (password_verify($password, $userData['password'])) { // Use password_verify
                // Successful login
    ...
    <div class="mt-8">
        ...
        <form method="post" action="login-form-bcrypt.php" autoComplete="off">
            ...
            <div class="flex items-center justify-center mt-6">
                <a href="registration-form-bcrypt.php" class="inline-flex items-center text-xs font-thin text-center text-gray-500 hover:text-gray-700 dark:text-gray-100 dark:hover:text-white">
                    <span class="ml-2">
